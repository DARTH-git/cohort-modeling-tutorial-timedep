...
We discount both costs and QALYs at an annual rate of `r percent(d_c)`. Model parameters and the corresponding R variable names are presented in Table \@ref(tab:param-table). We follow the notation described in the DARTH coding framework.[@Alarid-Escudero2019e] 
...
knitr::include_graphics("figs/Figure 2 - 3D-state-transition-array-sick-sicker-without-tunnels.pdf")
```
...
## Incorporating time dependency on state residence (tunnel states)
