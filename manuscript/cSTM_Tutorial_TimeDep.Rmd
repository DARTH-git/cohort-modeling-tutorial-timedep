...
knitr::include_graphics("figs/Figure 2 - 3D-state-transition-array-sick-sicker-without-tunnels.png")
```
...
knitr::include_graphics("figs/Figure 5 - 3D-state-transition-array-sick-sicker-tunnels.png")
```
